...
class ReservationAdapter(
    ...
    inner class ReservationViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val nameTextView: TextView = itemView.findViewById(R.id.name_item_reservation)
        private val checkInTextView: TextView = itemView.findViewById(R.id.checkin_item_reservation)
        private val checkOutTextView: TextView = itemView.findViewById(R.id.checkout_item_reservation)
        private val additionalNeedsTextView: TextView = itemView.findViewById(R.id.additional_needs_item_reservation)
        private val totalPriceTextView: TextView = itemView.findViewById(R.id.total_price_item_reservation)
        private val depositPaidImageView: ImageView = itemView.findViewById(R.id.depositpaid_item_reservation)
